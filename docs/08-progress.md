...
- Backend:
  - API `auth/login` para autenticação JWT.
  - API `clientes` com CRUD completo.
  - API `equipamentos` com CRUD completo.
...
- Frontend:
  ...
  - Página de equipamentos com listagem, criação, edição e exclusão.
  - Página de ordens de serviço com listagem, criação, alteração de status, remoção e histórico.
  - Navegação entre as telas de clientes, equipamentos e ordens de serviço.
